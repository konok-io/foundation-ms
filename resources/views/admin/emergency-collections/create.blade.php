    ...
    <div class="col-md-10 mx-auto">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Create Emergency Collection</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.emergency-collections.store') }}" method="POST" data-loading>
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="description_bn" name="description_bn" rows="2">{{ old('description_bn') }}</textarea>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('target_amount') is-invalid @enderror" id="target_amount" name="target_amount" value="{{ old('target_amount', 0) }}" step="0.01" min="0" required>
                                @error('target_amount')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="amount_per_member" name="amount_per_member" value="{{ old('amount_per_member', 0) }}" step="0.01" min="0">
                                <small class="text-muted">Leave 0 to skip auto-assignment</small>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="status" name="status">
                                    ...
                                    <option value="{{ $key }}" {{ old('status', 'draft') == $key ? 'selected' : '' }}>{{ $status }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="mb-3">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="assign_to_members">
                                Automatically assign to all active members when activated
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4">
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-check-lg me-2"></i>Create Collection
                        </button>
                    </div>
                </form>
            </div>

...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .admin-sidebar.collapsed .sidebar-brand-text, .admin-sidebar.collapsed .sidebar-subtitle, .admin-sidebar.collapsed .sidebar-section-title, .admin-sidebar.collapsed .nav-link-text, .admin-sidebar.collapsed .user-info, .admin-sidebar.collapsed .badge-text { display: none !important; }
        ...
        .user-profile { padding: 20px; border-bottom: 1px solid rgba(255,255,255,0.1); background: rgba(0,0,0,0.1); }
        .user-profile-inner { display: flex; align-items: center; gap: 12px; }
        .user-avatar { width: 48px; height: 48px; border-radius: 12px; background: linear-gradient(135deg, var(--primary) 0%, var(--secondary) 100%); display: flex; align-items: center; justify-content: center; color: white; font-weight: 600; font-size: 1.1rem; box-shadow: 0 4px 15px rgba(0,0,0,0.3); }
        .user-info { flex: 1; min-width: 0; }
        .user-name { color: white; font-weight: 600; font-size: 0.95rem; margin: 0; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
        ...
        .badge-count { background: rgba(255,255,255,0.2); color: white; padding: 2px 8px; border-radius: 20px; font-size: 0.7rem; font-weight: 600; margin-left: auto; }
        .badge-count.bg-danger { background: var(--danger); }
        ...
        .stat-card { background: white; border-radius: 16px; padding: 25px; position: relative; overflow: hidden; transition: all 0.3s ease; border: none; box-shadow: 0 4px 20px rgba(0,0,0,0.06); }
        ...
        .stat-card.primary::before { background: linear-gradient(90deg, var(--primary), var(--info)); }
        .stat-card.success::before { background: linear-gradient(90deg, var(--secondary), var(--success)); }
        .stat-card.warning::before { background: linear-gradient(90deg, var(--accent), var(--warning)); }
        .stat-card.danger::before { background: linear-gradient(90deg, var(--danger), #F87171); }
        .stat-card .stat-icon { width: 60px; height: 60px; border-radius: 14px; display: flex; align-items: center; justify-content: center; font-size: 1.5rem; margin-bottom: 15px; }
        .stat-card.primary .stat-icon { background: rgba(14, 116, 144, 0.1); color: var(--primary); }
        .stat-card.success .stat-icon { background: rgba(22, 163, 74, 0.1); color: var(--secondary); }
        .stat-card.warning .stat-icon { background: rgba(245, 158, 11, 0.1); color: var(--accent); }
        .stat-card.danger .stat-icon { background: rgba(239, 68, 68, 0.1); color: var(--danger); }
        .stat-card .stat-value { font-size: 2rem; font-weight: 700; color: var(--dark); margin-bottom: 5px; font-family: 'Poppins', sans-serif; }
        .stat-card .stat-label { font-size: 0.85rem; color: var(--gray-500); font-weight: 500; }
        .stat-card .stat-change { display: inline-flex; align-items: center; gap: 5px; font-size: 0.8rem; padding: 3px 10px; border-radius: 20px; margin-top: 10px; }
        ...
        .stat-card .stat-link { position: absolute; bottom: 20px; right: 20px; color: var(--gray-400); transition: all 0.3s ease; }
        .stat-card:hover .stat-link { color: var(--primary); transform: translateX(5px); }
        ...
        .btn-outline-success { border: 2px solid var(--secondary); color: var(--secondary); padding: 8px 22px; border-radius: 10px; font-weight: 600; transition: all 0.3s ease; background: transparent; }
        .btn-outline-success:hover { background: var(--secondary); color: white; transform: translateY(-2px); }
        ...
        .empty-state-icon { width: 80px; height: 80px; background: var(--gray-100); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 20px; font-size: 2rem; color: var(--gray-400); }
        .empty-state h5 { font-weight: 600; color: var(--gray-700); margin-bottom: 10px; }

...
<li class="breadcrumb-item"><a href="{{ route('admin.members.show', $member) }}">{{ $member->member_id }}</a></li>
    ...
    <div class="col-md-10 mx-auto">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Edit Member: {{ $member->member_id }}</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.members.update', $member) }}" method="POST" enctype="multipart/form-data" data-loading>
                    @csrf
                    @method('PUT')
                    ...
                    <div class="tab-content" id="memberTabContent">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3 text-center">
                                        ...
                                        <div class="photo-preview mb-2">
                                            <img src="{{ $member->avatar_url }}" alt="Preview" id="photoPreview" class="rounded-circle" width="120" height="120" style="object-fit: cover;">
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control @error('father_name') is-invalid @enderror" id="father_name" name="father_name" value="{{ old('father_name', $member->father_name) }}" required>
                                                @error('father_name')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control @error('mother_name') is-invalid @enderror" id="mother_name" name="mother_name" value="{{ old('mother_name', $member->mother_name) }}" required>
                                                @error('mother_name')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="date" class="form-control @error('date_of_birth') is-invalid @enderror" id="date_of_birth" name="date_of_birth" value="{{ old('date_of_birth', $member->date_of_birth?->format('Y-m-d')) }}" required>
                                                @error('date_of_birth')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select @error('gender') is-invalid @enderror" id="gender" name="gender" required>
                                                    ...
                                                    <option value="{{ $key }}" {{ old('gender', $member->gender) == $key ? 'selected' : '' }}>{{ $gender }}</option>
                                                    @endforeach
                                                </select>
                                                @error('gender')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" id="blood_group" name="blood_group">
                                                    ...
                                                    <option value="{{ $key }}" {{ old('blood_group', $member->blood_group) == $key ? 'selected' : '' }}>{{ $group }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                        ...
                        <div class="tab-pane fade" id="address">
                            ...
                            <div class="mb-3">
                                <textarea class="form-control @error('present_address') is-invalid @enderror" id="present_address" name="present_address" rows="3" required>{{ old('present_address', $member->present_address) }}</textarea>
                                @error('present_address')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-3">
                                <textarea class="form-control" id="present_address_bn" name="present_address_bn" rows="2" placeholder="বর্তমান ঠিকানা (Bangla)">{{ old('present_address_bn', $member->present_address_bn) }}</textarea>
                            </div>
                            
                            <hr>
                            <h6>Permanent Address</h6>
                            <div class="mb-3">
                                <textarea class="form-control" id="permanent_address" name="permanent_address" rows="3">{{ old('permanent_address', $member->permanent_address) }}</textarea>
                            </div>
                            <div class="mb-3">
                                <textarea class="form-control" id="permanent_address_bn" name="permanent_address_bn" rows="2" placeholder="স্থায়ী ঠিকানা (Bangla)">{{ old('permanent_address_bn', $member->permanent_address_bn) }}</textarea>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="designation" name="designation" value="{{ old('designation', $member->designation) }}">
                                    </div>
                                </div>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="national_id" name="national_id" value="{{ old('national_id', $member->national_id) }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label for="passport_number" class="form-label">Passport Number</label>
                                        <input type="text" class="form-control" id="passport_number" name="passport_number" value="{{ old('passport_number', $member->passport_number) }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label for="iqama_number" class="form-label">Iqama Number</label>
                                        <input type="text" class="form-control" id="iqama_number" name="iqama_number" value="{{ old('iqama_number', $member->iqama_number) }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control @error('join_date') is-invalid @enderror" id="join_date" name="join_date" value="{{ old('join_date', $member->join_date?->format('Y-m-d')) }}" required>
                                        @error('join_date')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="member_type" name="member_type">
                                            ...
                                            <option value="{{ $key }}" {{ old('member_type', $member->member_type) == $key ? 'selected' : '' }}>{{ $type }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="position" name="position">
                                            ...
                                            <option value="{{ $key }}" {{ old('position', $member->position) == $key ? 'selected' : '' }}>{{ $pos }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="referrer_member_id" name="referrer_member_id" value="{{ old('referrer_member_id', $member->referrer_member_id) }}">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4">
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-check-lg me-2"></i>Update Member
                        </button>
                    </div>
                </form>
            </div>

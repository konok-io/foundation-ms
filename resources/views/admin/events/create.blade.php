...
<li class="breadcrumb-item active">{{ $event ? 'Edit' : 'Create' }}</li>
    ...
    <div class="col-md-8 mx-auto">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">{{ $event ? 'Edit Event' : 'Create New Event' }}</h5>
            </div>
            <div class="card-body">
                <form action="{{ $event ? route('admin.events.update', $event) : route('admin.events.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4">
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-check-lg me-2"></i>{{ $event ? 'Update Event' : 'Create Event' }}
                        </button>
                    </div>
                </form>
            </div>

    ...
    public function run(): void
    {
        $activities = [
            [
                ...
                'budget' => 150000,
                'status' => 'completed',
                'images' => json_encode(['activity1.jpg', 'activity2.jpg']),
            ],
            [
                ...
                'budget' => 80000,
                'status' => 'completed',
                'images' => json_encode(['medical1.jpg', 'medical2.jpg']),
            ],
            [
                ...
                'budget' => 200000,
                'status' => 'completed',
                'images' => json_encode(['edu1.jpg', 'edu2.jpg']),
            ],
            [
                ...
                'budget' => 30000,
                'status' => 'completed',
                'images' => json_encode(['blood1.jpg', 'blood2.jpg']),
            ],
        ];
